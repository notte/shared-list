...
const mockCards = [
  {
    ...
    createdBy: { userId: "u001", userName: "小明", userRole: UserRole.Admin },
  ...
  },
  {
    ...
    createdBy: { userId: "u002", userName: "小華", userRole: UserRole.Member },
  ...
  },
  {
    ...
    createdBy: { userId: "u003", userName: "小美", userRole: UserRole.Member },
    address: "新北市淡水區中正路",
    ...
    <>
      {mockCards.map((card) => (
        <CardItem
          ...
          createdBy={card.createdBy as User}
        />
      ))}
    </>
  )
